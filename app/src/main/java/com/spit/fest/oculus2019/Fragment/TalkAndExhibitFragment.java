 ...
 */
public class TalkAndExhibitFragment extends Fragment {

    private EventAdapter eventAdapter;

    public TalkAndExhibitFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_talk_and_exhibit, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        populateEventList();
        RecyclerView recyclerView = view.findViewById(R.id.recycler_view_talk_and_exhibit);
